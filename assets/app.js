...
const S8_TRANSLATIONS = [
  ...
  ["Questa pagina raccoglie la versione esplorabile dei grafici della presentazione, con dataset, fonti e script collegati per rendere verificabili i numeri discussi nell'incontro e supportare una discussione pubblica evidence-based.", "This page collects the explorable version of the presentation charts, with datasets, sources and linked scripts so that the figures discussed in the meeting can be checked and used in evidence-based public discussion."],
  ...
  ["Rilevanza per le politiche pubbliche", "Policy relevance"],
  ["La lettura politica resta separata dall'analisi: qui sono esplicitate le domande che i dati aiutano a porre.", "The political reading remains separate from the analysis: this section makes explicit the questions that the data help raise."],
  ["Questa analisi offre una base empirica trasparente per il dibattito pubblico sulla linea S8 Milano-Lecco. I dati suggeriscono una crescita rilevante della domanda rispetto al 2019, non limitata alla fascia tradizionale 7-9, e indicano che la linea funziona sempre più come infrastruttura ordinaria del territorio meratese.", "This analysis provides a transparent evidence base for public discussion on the S8 Milano-Lecco rail line. The data suggest substantial demand growth compared with 2019, not limited to the traditional 7-9 morning peak, and indicate that the line increasingly works as everyday territorial infrastructure for the Meratese area."],
  ["Queste evidenze aprono domande di programmazione su frequenza, affidabilità, capacità, accessibilità alle stazioni e integrazione con autobus, bici e parcheggi.", "These findings raise planning questions about frequency, reliability, capacity, station accessibility and integration with buses, cycling infrastructure and parking."],
  ["Priorità basate sui dati", "Evidence-based priorities"],
  ["I dati indicano che la S8 non dovrebbe essere letta solo come corridoio pendolare del mattino. La crescita distribuita nella giornata rende rilevanti anche servizio fuori punta, connessioni locali, qualità delle stazioni e accessibilità reale per chi vive nel bacino della linea.", "The data indicate that the S8 should not be read only as a morning commuter corridor. Growth distributed across the day makes off-peak service, local connections, station quality and real accessibility for people living in the line's catchment area relevant planning issues."],
  ["Interlocuzione istituzionale", "Policy engagement"],
  ["L'analisi è stata discussa con amministratori locali del Meratese. Sono stato invitato a spiegare i dati al Sindaco di Merate e ho preparato un approfondimento a livello di stazione su Paderno-Robbiate a seguito dell'interesse del Sindaco di Paderno d'Adda. Un consigliere regionale ha inoltre manifestato interesse a utilizzare il lavoro come base per futuri appuntamenti di approfondimento sulla linea S8.", "The analysis has been discussed with local administrators in the Meratese area. I was asked to explain the findings to the Mayor of Merate and prepared a station-level deep dive on Paderno-Robbiate following interest from the Mayor of Paderno d'Adda. A regional councillor also expressed interest in using the work as a basis for future stakeholder discussions on the S8 line."],
  ["Il mio contributo resta tecnico e analitico: dati, metodo, visualizzazioni e interpretazione. Le proposte politiche sono tenute distinte dalla base empirica.", "My contribution remains technical and analytical: data, methods, visualisations and interpretation. Political proposals are kept separate from the evidence base."],
  ["Limiti dell'analisi", "Limits of the analysis"],
  ["Questa analisi non misura direttamente sovraffollamento, domanda repressa, qualità operativa o effetto causale di specifiche modifiche d'orario. Serve a informare la discussione pubblica e le domande istituzionali, non a sostituire la programmazione operativa o i dati interni di gestori e autorità regionali.", "This analysis does not directly measure overcrowding, suppressed demand, operational quality or the causal effect of specific timetable changes. It should inform public discussion and institutional questions, not replace operational planning or internal data held by transport providers and regional authorities."],
