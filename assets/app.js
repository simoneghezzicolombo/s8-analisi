...
const S8_TRANSLATIONS = [
  ...
  ["Questa pagina raccoglie la versione esplorabile dei grafici della presentazione, con dataset, fonti e script collegati per rendere verificabili i numeri discussi nelle presentazioni pubbliche e nelle interlocuzioni locali.", "This page collects the explorable version of the presentation charts, with datasets, sources and linked scripts so that the figures discussed in public presentations and local conversations can be checked."],
  ...
  ["Rilevanza istituzionale e di policy", "Policy and institutional relevance"],
  ...
  ["L'analisi è entrata nel dibattito pubblico locale e ha supportato discussioni evidence-based su domanda ferroviaria, accessibilità territoriale e programmazione del servizio. In alcuni casi sono stati preparati approfondimenti specifici a livello di stazione per rispondere a domande emerse nelle interlocuzioni locali.", "The analysis has circulated in local public discussion and has supported evidence-based conversations on rail demand, territorial access and service planning. In some cases, station-level deep dives were prepared to respond to questions raised in local conversations."],
